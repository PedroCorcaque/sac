...
class SAC():
    ...
    def __init__(self, state_dim, action_dim, learning_rate=0.001, gamma=0.99, alpha=0.2, \
        ...
        self.policy = PolicyNetwork(self.state_dim, self.action_dim, \
                                    hidden_size=hidden_layer).to(self.device)
        self.target_policy = PolicyNetwork(self.state_dim, self.action_dim, \
                                           hidden_size=hidden_layer).to(self.device)
